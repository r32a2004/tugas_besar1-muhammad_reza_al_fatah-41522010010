...
public class spin_well_bulanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spin_well_bulanan);
    ...
    public void showPopup(String points) {
        ...
        dialog.setContentView(R.layout.activity_win_popup);
